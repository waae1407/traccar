    ...
    <div className="space-y-5 animate-fade-in-up">
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold text-white mt-1">Financial Control Center</h1>
          <p className="text-sm text-muted-foreground mt-2 max-w-4xl">Central workspace for reconciliation, confidence, payout readiness, exceptions, audit history, planning, and standardized exports.</p>
        </div>
