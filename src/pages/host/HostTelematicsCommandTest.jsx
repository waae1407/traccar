  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-black text-gray-950">Command Verification</h1>
        <p className="mt-2 text-sm text-gray-500">Verify supported vehicle actions for devices assigned to your vehicles only.</p>
      </div>
