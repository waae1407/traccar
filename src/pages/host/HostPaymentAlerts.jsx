...
export default function HostPaymentAlerts() {
  ...
  const host = hosts[0];
  return <div className="space-y-5"><HostPageHeader title="Payment Alerts" subtitle="Action-required payment issues for your fleet" /><PaymentOperationsAlertCenter scope="host" hostId={host?.id} /></div>;
}