  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
      <div className="glass rounded-2xl p-4 xl:col-span-2">
        <p className="text-xs uppercase tracking-[0.25em] text-primary font-bold mb-3">Rollback Governance System</p>
      ...
      <div className="glass rounded-2xl p-4">
        ...
        <p className="text-sm text-white/55 mb-3">{audit.length} immutable audit snapshots prepared, no writes enabled.</p>
