...
function StripePaymentForm({ booking, user, onPaymentSuccess, paymentIntentId, stripeCustomerId, clientSecret }) {
  ...
  // Mark as ready once stripe, elements, and clientSecret are present
  useEffect(() => {
    if (stripe && elements && clientSecret) {
      console.log("[Payment] ✓ Stripe, elements, and clientSecret ready");
      // Give DOM a tick to render PaymentElement before marking mounted
