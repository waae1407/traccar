      ...
      <CardContent className="p-5">
        <div className="flex flex-col gap-3 md:flex-row">
          <Input
            ...
            placeholder="Enter a vehicle or device identifier"
        ...
        {error && <p className="mt-3 text-sm font-semibold text-red-300">{businessText(error)}</p>}
        <p className="mt-3 text-xs text-white/45">Search by a secure vehicle or device identifier.</p>
      </CardContent>
    </Card>
  );
}