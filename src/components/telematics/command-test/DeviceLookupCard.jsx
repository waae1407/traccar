      ...
      <CardContent className="p-5">
        <div className="flex flex-col gap-3 md:flex-row">
          <Input
            ...
            placeholder="Enter unique_id, IMEI, provider ID, Traccar ID, or MooveTrax ID"
        ...
        <p className="mt-3 text-xs text-white/45">Matches unique_id, device_imei, provider_device_id, traccar_device_id, and moovetrax_device_id.</p>
      </CardContent>
    </Card>
  );
}