...
const PHOTO_SLOTS = [
  ...
  },
  {
    ...
    aiPrompt: "The same cartoon vehicle from the front-left 45-degree angle (driver side), showing the front bumper and left driver-side panel together in one diagonal view. Keep the same cartoon illustration style.",
    icon: "↖️",
  },
  {
  ...
  },
  {
    ...
    aiPrompt: "The same cartoon vehicle from the front-right 45-degree angle (passenger side), showing the front bumper and right passenger-side panel together in one diagonal view. Keep the same cartoon illustration style.",
    icon: "↗️",
  },
  {
